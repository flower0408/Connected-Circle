package rs.ac.uns.ftn.svtkvtproject.security;
...
import rs.ac.uns.ftn.svtkvtproject.service.implementation.UserDetailsServiceImpl;
...
//                .antMatchers("/h2-console/**").permitAll()	// /h2-console/** ako se koristi H2 baza)
                ...
                .antMatchers(HttpMethod.GET, "/api/groups/name/{name}").permitAll()
                .antMatchers(HttpMethod.GET, "/api/groups/description/{description}").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/api/posts/search-by-likes").permitAll()
                .antMatchers(HttpMethod.GET, "/api/posts/search").permitAll()
                .antMatchers(HttpMethod.GET, "/api/posts/number-of-comments").permitAll()
